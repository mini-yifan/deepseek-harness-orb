...
- Visible GUI (open WeChat, click a button in Pages) uses GUI tools (click, input_text, scroll, hotkey, wait, long_press, drag, open_in_browser, open_in_finder) and does not call the background agent.
