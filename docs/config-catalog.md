...
Requires: `tools` · `systemPrompt` · `attachments`
...
Source: [`packages/experimental/tool-computer-use/src/config.ts:9`](../packages/experimental/tool-computer-use/src/config.ts)
