...
This cut does not add Accessibility `click_element`, background virtual cursors, overlay aiming grids, stitched menus or palettes, or Windows/Linux production backends.
