...
export const SERVICE_WALK_EXEMPTIONS: Record<string, string> = {
  ...
  computerUseOverlayGuard: 'optional Desktop overlay cloak around Computer Use capture and HID; Desktop Host provides it, other compositions omit it — packages/experimental/tool-computer-use/README.md owns this overlay contract',
