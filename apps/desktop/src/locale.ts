...
export const en = {
  ...
  aboutMenu: 'About DeepSeek Orb',
  aboutProduct: 'DeepSeek Orb',
  aboutVersion: 'Version V{version}',
  hideApplication: 'Hide DeepSeek Orb',
  hideOtherApplications: 'Hide Others',
  showAllApplications: 'Show All',
  quitApplication: 'Quit DeepSeek Orb',
  edit: 'Edit',
  ...
  startupFailed: 'DeepSeek Orb is unavailable',
  ...
  welcomeTitle: 'DeepSeek Orb',
  welcomeBrand: 'DeepSeek Orb',
  welcomeTaglineBefore: 'Welcome to ',
  welcomeTaglineBrand: 'DeepSeek Orb',
  welcomeTaglineAfter: '',
  ...
  updateDownloadedTitle: 'DeepSeek Orb v{version} downloaded',
  ...
  updateDetail: 'DeepSeek Orb {version}\n\nDeepSeek Orb will restart to complete the update.',
...
export const zh = {
  application: '应用',
  aboutMenu: '关于 DeepSeek Orb',
  aboutProduct: 'DeepSeek Orb',
  aboutVersion: '版本 V{version}',
  hideApplication: '隐藏 DeepSeek Orb',
  hideOtherApplications: '隐藏其他',
  showAllApplications: '显示全部',
  quitApplication: '退出 DeepSeek Orb',
  edit: '编辑',
  menuBar: '应用菜单',
  delete: '删除',
  undo: '撤销',
  ...
  paste: '粘贴',
  selectAll: '全选',
  startupFailed: 'DeepSeek Orb 无法使用',
  ...
  updateDownload: '下载更新',
  updateDownloadedTitle: 'DeepSeek Orb v{version} 下载完成',
