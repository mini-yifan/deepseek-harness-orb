...
import { runDesktopPluginArgs } from '../src/plugin-run.ts'
import type { DesktopProjectManager } from '../src/project-manager.ts'

function manager(mutateWhileRunning: DesktopProjectManager['mutateWhileRunning']): DesktopProjectManager {
  return { mutateWhileRunning } as DesktopProjectManager
}
