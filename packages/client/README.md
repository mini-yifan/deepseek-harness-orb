...
| [`ui-settings-orb/`](ui-settings-orb/README.md) | Desktop Settings page for the floating-ball avatar, Agent models, selection toolbar, and millifraction coordinates | — |
