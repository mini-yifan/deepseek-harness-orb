...
export class ClientModuleRegistry extends Service {
  ...
  constructor(ctx: Context) {
    ...
    const registerWebCarrier = (host: Context, server: WebServer): void => {
      host.effect(
    ...
    if (existing === undefined) ctx.inject(['webServer'], webCtx => registerWebCarrier(webCtx, webCtx.webServer))
    else registerWebCarrier(ctx, existing)
