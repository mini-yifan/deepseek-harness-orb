...
| [`tool-computer-use`](tool-computer-use/README.md) | Five GUI tools that attach host desktop screenshots to the existing agent-loop | registers exclusive tools on `ctx.tools` |
