...
| [`tool-computer-use`](tool-computer-use/README.md) | Thirteen exclusive GUI tools plus an overlay-registered Computer Use agent preset | scoped exclusive tools on `ctx.tools` |
